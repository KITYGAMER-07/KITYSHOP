...
export const FaqPage: React.FC<FaqPageProps> = ({ storeName = 'PeakLoader Shop' }) => {
  ...
  const faqs = [
    ...
    {
      q: `What payment methods are supported on ${storeName}?`,
    ...
    },
    {
      ...
      a: `All keys delivered by ${storeName} are tested before being listed into inventory. In the rare event of activation difficulty, reach out to our support via Telegram or the Support contact form with your Order Reference ID for immediate assistance or replacement.`,
      icon: ShieldCheck
    },
    {
  ...
  return (
    <div className="py-10 max-w-3xl mx-auto px-4">
      <div className="text-center mb-10">
        ...
        <p className="mt-1.5 text-sm text-slate-400">Everything you need to know about purchasing and using license keys on {storeName}.</p>
      </div>
